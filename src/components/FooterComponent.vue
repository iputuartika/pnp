<template>
  <footer
    class="flex justify-between items-center border-t bg-white border-b border-gray-200 px-4 py-2 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 bottom-0 z-50"
  >
    ...
    <div class="flex mb-4 text-sm justify-center text-gray-500 dark:text-gray-400 sm:mb-0">
      © 2023 Made with <HeartIcon class="w-5 h-5 mx-1 text-red-600" />
      by I Putu Artika, S.Kom.
    </div>
